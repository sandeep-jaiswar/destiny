...
import { useGetChartDataQuery } from "@/app/store/chartApi";

interface ChartClientProps {
  symbol: string;
}

export function ChartClient({ symbol }: ChartClientProps) {
  // Use RTK Query hook to fetch and cache data
      ...
      <div className="container mx-auto p-8">
        <div className="flex items-center justify-center h-96">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading chart data for {symbol.toUpperCase()}...</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="container mx-auto p-8">
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded">
          ...
          <p>Failed to load chart data for {symbol.toUpperCase()}. Please try again later.</p>
        </div>
      </div>
    );
  }
